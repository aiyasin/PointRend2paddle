...
class FPN(object):
    ...
    def __init__(
        ...
        input_shapes = {'res2': ShapeSpec(channels=256, height=None, width=None, stride=4), 
        ...
        for idx, in_channels in enumerate(in_channels_per_feature):
            ...
            w_attr_1, b_attr_1 = _init_weights()
            lateral_conv = Conv2d(
                in_channels, out_channels, kernel_size=1, bias_attr=use_bias,weight_attr = w_attr_1, norm=lateral_norm
            )
            output_conv = Conv2d(
                out_channels,
                out_channels,
...
class LastLevelP6P7(nn.Layer):
    ...
    def __init__(self, in_channels, out_channels, in_feature="res5"):
        ...
        w_attr_2, b_attr_2 = _init_weights()
        self.p6 = nn.Conv2D(in_channels, out_channels, 3, 2, 1,weight_attr=w_attr_2,)
        self.p7 = nn.Conv2D(out_channels, out_channels, 3, 2, 1,weight_attr=w_attr_2,)
